...
import MasterBasisData from 'src/components/pages/penilaian-perkebunan/NilaiMasterPage';
import { useSnackbar } from 'notistack';
import CustomComponent from 'src/components/snackbar/CustomComponent';

const PenilaianPerkebunanPage = () => {
        ...
        <div className="items-center justify-between py-6 px-8">
          <div>
            <BreadCrumbs
              links={[
                {
                  path: '/penilaian-perkebunan',
                  title: 'Penilaian Perkebunan',
                },
              ]}
            />
            <div className="mt-3 text-2xl font-semibold">Penilaian Perkebunan</div>
          </div>
        </div>
...
export default PenilaianPerkebunanPage;

    ...
    <>
      ...
      <div className="mt-6 grid w-full grid-cols-2 gap-2">
        ...
        <InputForm
          ...
          className={`${
            isError && 'border-primary-red-1 bg-primary-red-2'
          } w-full rounded border bg-white-2 py-3 px-6  text-base uppercase text-primary-gray-4`}
          iconEmail="true"
        />
      </div>
      <div className="mt-6">
      ...
      <textarea
        ...
        className={`${
          isError && 'border-primary-red-1 bg-primary-red-2'
        } disabled:hover mb-6 h-32 w-full rounded bg-white-2 py-3 px-6 text-black placeholder:text-base`}
      ></textarea>

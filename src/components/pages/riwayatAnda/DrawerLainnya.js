...
import FormLainnya from '../elementDTW/FormLainnya';

const DrawerLainnya = ({ isOpen, handleClose }) => {
  return (
    <div
    ...
    >
      <div className="p-7">
        ...
        <div className="mt-5">
          <div className="text-2xl font-semibold">Lain-lain</div>
          <FormLainnya />
        </div>
      </div>
    </div>

...
import FormAksebilitas from '../elementDTW/FormAksebilitas';
import FormAmenitas from '../elementDTW/FormAmenitas';

const DrawerAmenitas = ({ isOpen, handleClose }) => {
  return (
    <div
    ...
    >
      <div className="p-7">
        ...
        <div className="mt-5">
          <div className="text-2xl font-semibold">Amenitas & Fasilitas</div>
          <FormAmenitas />
        </div>
      </div>
    </div>

...
import FormInformasiUmum from '../elementDTW/FormInformasiUmum';

const DrawerInformasiUmum = ({ isOpen, handleClose }) => {
  return (
    <div
    ...
    >
      <div className="p-7">
        ...
        <div className="mt-5">
          <div className="text-2xl font-semibold">Informasi Umum</div>
          <FormInformasiUmum />
        </div>
      </div>
    </div>
...
export default DrawerInformasiUmum;

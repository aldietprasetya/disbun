...
const GrafikHargaJual = () => {
  ...
  const [dataTable, setDataTable] = useState(lineChart)
  ...
  return (
    <>
      <div className="text-[24px] font-semibold leading-9 mt-[27px]">Grafik Harga Jual Komoditas (Rp/Kg)</div>
      ...
      <div className="bg-white rounded-md px-[22px] py-[19px]">
        <div className="mb-[41px]">
          <div className="text-lg	font-semibold text-primary-blue-3">Harga Jual Komoditas (Rp/Kg)</div>
          <div className="text-[15px] text-primary-light-gray-1">Tahun 2021</div>
        </div>
        <div>
          <ReactApexChart options={dataTable.options} series={dataTable.series} type="line" height={377} />
        </div>
      </div>
    </>
  );
...
export default GrafikHargaJual;
